...
/**
 * Created by Alexlou on 2020/6/30.
 */
@SpringBootTest
...
public class TestIndex {
    ...
    public void testQueryDoc() throws IOException {
        GetRequest getRequest = new GetRequest("xc_course","doc","ZtoVBHMBj8GnV_Pvsftn");
...
//删除文档id
        String id = "ZtoVBHMBj8GnV_Pvsftn";
//删除索引请求对象
